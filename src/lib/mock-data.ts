...
export const mockIssues: Issue[] = [
  ...
  },
  {
    ...
    statusHistory: [
      ...
      { status: 'PendingEstimation', date: '2024-07-22T09:05:00Z', updatedBy: 'Gita Patel' },
  ...
  },
  {
    ...
    status: 'Verified',
    currentRole: 'Fund Manager',
    assignedEngineerId: 'user-3',
    assignedFundManagerId: 'user-4',
    statusHistory: [
        { status: 'Submitted', date: '2024-07-23T15:00:00Z', updatedBy: 'Alia Reddy' },
        { status: 'AssignedForVerification', date: '2024-07-23T15:30:00Z', updatedBy: 'Bhavin Shah' },
